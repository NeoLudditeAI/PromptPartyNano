  ...
  return (
    <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="turn-input" className="block text-sm font-medium text-gray-700 mb-2">
            Your contribution (as {getPlayerName(currentPlayerId)}):
          </label>
          <textarea
            id="turn-input"
            value={inputText}
            onChange={(e) => setInputText(e.target.value)}
            placeholder="Add a few words to the prompt... (max 25 characters)"
        ...
        >
          {isSubmitting ? 'Generating Image...' : 'Submit Turn'}
        </button>
      </form>
      
      <div className="mt-4 text-sm text-gray-600">
        <p>💡 Tip: Add descriptive words like "beautiful", "majestic", "vibrant" to create better images!</p>
